...
const CACHE_NAME = "Bouncy-cache";
const OFFLINE_URL = "Bouncy.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Bouncy.html","Bouncy.js","Bouncy.wasm","Bouncy.pck","Bouncy.offline.html","Bouncy.icon.png","Bouncy.apple-touch-icon.png"];
