...
const CACHE_NAME = "SlotMachine-cache";
const OFFLINE_URL = "SlotMachine.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["SlotMachine.html","SlotMachine.js","SlotMachine.wasm","SlotMachine.pck","SlotMachine.offline.html","SlotMachine.icon.png","SlotMachine.apple-touch-icon.png"];
