...
const CACHE_NAME = "Textify-cache";
const OFFLINE_URL = "Textify.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Textify.html","Textify.js","Textify.wasm","Textify.pck","Textify.offline.html","Textify.icon.png","Textify.apple-touch-icon.png"];
