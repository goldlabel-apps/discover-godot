...
const CACHE_NAME = "JsonLoader-cache";
const OFFLINE_URL = "JsonLoader.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["JsonLoader.html","JsonLoader.js","JsonLoader.wasm","JsonLoader.pck","JsonLoader.offline.html","JsonLoader.icon.png","JsonLoader.apple-touch-icon.png"];
