...
const CACHE_NAME = "Physics-cache";
const OFFLINE_URL = "Physics.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Physics.html","Physics.js","Physics.wasm","Physics.pck","Physics.offline.html","Physics.icon.png","Physics.apple-touch-icon.png"];
